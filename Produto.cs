...
public class Produto 
{
  ...
  public static List<Produto> ConsultarProdutos()
  {
   ...
   public static List<Produto> ProcurarProdutos(string especificos)
  {
    ...
    using (var connection = new SqliteConnection("Data Source=banco.db"))
    {
      ...
      @"
        SELECT * 
        FROM produto 
        WHERE produto.nome LIKE ($produtosespecificos);
       ";

      command.Parameters.AddWithValue("$produtosespecificos",especificos);
